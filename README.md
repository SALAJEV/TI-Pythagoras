...
Recentste versie: 1.0.3

## Installatie-instructies:
1. Download het bestand SALAVATOR_TI_Pythagoras_v***.8xp naar je computer. (We raden je aan om de nieuwste versie te gebruiken.)
2. Verbind de rekenmachine met de computer via een mini-USB naar USB-kabel.
3. Open TI Connect CE op je computer.
4. Sleep het bestand SALAVATOR_TI_Pythagoras_v***.8xp naar TI Connect CE om het programma over te dragen naar de rekenmachine.
...
Link naar onze website: https://bit.ly/salavator-ti.
